...
const List<PowerDescriptor> kPowerCatalog = <PowerDescriptor>[
  ...
  PowerDescriptor(
    ...
    fallback: PowerFallback(
      hint: '实时服务未接入时按本地已有的人设与记忆展示，不伪造对话与收益',
